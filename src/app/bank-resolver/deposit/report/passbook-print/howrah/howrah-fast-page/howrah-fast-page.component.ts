...
@Component({
  selector: 'app-howrah-fast-page',
  templateUrl: './howrah-fast-page.component.html',
  styleUrls: ['./howrah-fast-page.component.css']
})
export class HowrahFastPageComponent implements OnInit {
