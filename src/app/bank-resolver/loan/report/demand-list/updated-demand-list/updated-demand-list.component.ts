...
export class UpdatedDemandListComponent {
  ...
  diff:any;
  constructor(private datePipe:DatePipe,private svc: RestService, private formBuilder: FormBuilder,private exportAsService: ExportAsService, private cd: ChangeDetectorRef,
